...
> Shop overlay and presentation improvements for Data Center.
...
- [Repository](https://github.com/mleem97/gregMod.BetterShop)
...
```bash
dotnet build gregMod.BetterShop.csproj -c Release -p:Platform=x64
```
