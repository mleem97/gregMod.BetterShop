...
> Copy `gregMod.BetterShop.dll` to `Data Center/Mods/`.

![License](https://img.shields.io/github/license/mleem97/gregMod.BetterShop?style=for-the-badge) ![Last commit](https://img.shields.io/github/last-commit/mleem97/gregMod.BetterShop?style=for-the-badge) ![Repo size](https://img.shields.io/github/repo-size/mleem97/gregMod.BetterShop?style=for-the-badge) ![Stars](https://img.shields.io/github/stars/mleem97/gregMod.BetterShop?style=for-the-badge)

## Links

- **Steam Workshop:** [My Workshop (Data Center)](https://steamcommunity.com/id/frikadelle3000/myworkshopfiles/?appid=4170200)
- **Repository:** [https://github.com/mleem97/gregMod.BetterShop](https://github.com/mleem97/gregMod.BetterShop)
- **Issues:** [https://github.com/mleem97/gregMod.BetterShop/issues](https://github.com/mleem97/gregMod.BetterShop/issues)
- **Releases:** [https://github.com/mleem97/gregMod.BetterShop/releases](https://github.com/mleem97/gregMod.BetterShop/releases)

## Overview

**gregMod.BetterShop** — Copy `gregMod.BetterShop.dll` to `Data Center/Mods/`.
...
```bash
git clone https://github.com/mleem97/gregMod.BetterShop.git
cd gregMod.BetterShop
```
