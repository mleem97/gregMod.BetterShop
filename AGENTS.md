# AGENTS.md — Hinweise für KI-Agenten (gregMod.BetterShop)

Repo: [https://github.com/mleem97/gregMod.BetterShop](https://github.com/mleem97/gregMod.BetterShop) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
